...
switch(command){
			...
			case'help': {
				...
				anu = `${fke}Hi ${m.pushName} 👋, i'am ChanzX!${fke}
...
`,
					btn = [{
                                urlButton: {
                                    displayText: 'sᴜʙsᴄʀɪʙᴇ ᴏɴ ʏᴛ',
                                    url: 'https://youtube.com/IchanGaming'
                                }
                            }, {
                                urlButton: {
                                    displayText: 'ɢʀᴏᴜᴘ ᴡʜᴀᴛꜱᴀᴘᴘ',
                                    url: 'https://chat.whatsapp.com/HAuGuITXBth2KLL16k01Ri'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '❗ ᴄʀᴇᴅɪᴛ',
				...
				conn.sendMessage(from, {text : `*🪄 This Ads Only*\n\n•───────────•\n${jsn[0].setting}\n•───────────•\n\n_© 2022 IchanzX CoderID_`}, {quoted :{
				key: { fromMe: false,
...
⊳ Url : ${anu.url}`,
			...
			case 'tt':
				...
				©️ *Creator:* IchanzXD Coder-ID 🇮🇩
				📌 *Title:* ${p.title}
				👤 *Author:* ${p.author}

				Subscribe My YT : Ichan Gaming
				`
				let buttons = [
